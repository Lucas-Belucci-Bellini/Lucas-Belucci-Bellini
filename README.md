...
| **[🗓 Daily Planner](https://github.com/Lucas-Belucci-Bellini/DailyPlanner)** | Agenda de horários que recusa dois compromissos no mesmo minuto. Páginas montadas no servidor, sem uma linha de JavaScript. *Schedule planner with conflict detection, fully server-rendered.* | `Java` `Spring Boot` `JPA` |
